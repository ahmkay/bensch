    ...
    <div className="App">
      ...
      <main>
        ...
        <Container maxWidth="md" className="container serviceContainer">
          ...
          Zum Auf- und Ausbau eines neues Team suchen wir für das Notarbüro ab dem 01. April 2024 zuverlässige, kommunikative und freundliche Mitarbeiter*innen (m/w/d) in Voll- oder Teilzeit.
          </Typography>
          <Typography variant='body1' className='sectionText'>
